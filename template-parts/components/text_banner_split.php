...
$image = isset($image) ? $image : get_sub_field('text_banner_split_image');
$title = isset($title) ? $title : get_sub_field('text_banner_split_title');
$text = isset($text) ? $text : get_sub_field('text_banner_split_text');
$link = isset($link) ? $link : get_sub_field('text_banner_split_link'); // ACF Link field returns an array
...
<div class="text-banner-split half-half padding-b-100">
    ...
    <div class="half black-bg white-text padding-100">
        <div class="text-banner-text">
            ...
            <?php endif; ?>
            <?php if ($text): ?>
                <p class="fs-600 fw-semibold margin-b-100"><?php echo wp_kses_post($text); ?></p>
            <?php endif; ?>
            <?php if ($link): ?>
