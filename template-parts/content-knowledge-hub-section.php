            ...
            <table>
                ...
                <tbody>
                    <?php foreach ($documents_array as $document) : 
                        ...
                        $brands_display = ($show_brands && !empty($document->associated_brands_label)) ? implode(', ', $document->associated_brands_label) : '';
                        $brand_data = ($show_brands && !empty($document->associated_brands)) ? implode(',', $document->associated_brands) : '';
                    ?>
                        <tr 
